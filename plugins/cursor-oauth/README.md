...
从 [GitHub Releases](https://github.com/xinghaix/CLIProxyAPI-Plugins-Store/releases) 下载对应平台的 ZIP 压缩包（例如 `cursor-oauth_0.6.3_darwin_arm64.zip` 或 `cursor-oauth_0.6.3_linux_amd64.zip`）。
