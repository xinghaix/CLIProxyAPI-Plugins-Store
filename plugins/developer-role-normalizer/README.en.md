...
Historical releases (0.3.8 and earlier) live under the shared `v<version>` tag; their install paths keep working. Every later version uses a plugin-scoped tag.
## Compatibility notes
