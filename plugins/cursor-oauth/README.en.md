...
Download the platform zip archive from [GitHub Releases](https://github.com/xinghaix/CLIProxyAPI-Plugins-Store/releases) (e.g. `cursor-oauth_0.6.1_darwin_arm64.zip` or `cursor-oauth_0.6.1_linux_amd64.zip`).
