...
- **Gateway captured (preferred):** official CPA commit [`ac3849e5d981e85dd3f713aae0691d23d7b3a56c`](https://github.com/router-for-me/CLIProxyAPI/commit/ac3849e5d981e85dd3f713aae0691d23d7b3a56c) adds `UsageRecord.ResponseModel` and propagates it through the usage adapter. The plugin prefers this official field; older versions or an empty value fall back to compatible `responseModel` / `response_model` extensions, then to stream capture.
